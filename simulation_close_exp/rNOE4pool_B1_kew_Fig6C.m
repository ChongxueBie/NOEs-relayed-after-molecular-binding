...
xlabel('\omega_1 (Hz)');
ylabel('rNOE (%)')
set(gca,'ytick',[0:5:200],'ylim',[0,100],'xtick',[0:10:1000],'xlim',[0,50],'fontsize',20)

lg = legend('k_{ew}=0 s^{-1}','k_{ew}=500 s^{-1}', 'k_{ew}=1000 s^{-1}','k_{ew}=2000 s^{-1}','k_{ew}=3000 s^{-1}','k_{ew}=4000 s^{-1}','location','southeast','fontsize',20);
...
ylabel('\alpha')
set(gca,'ytick',[0:0.2:200],'ylim',[0,1.05],'xtick',[0:100:1000],'xlim',[0,600],'fontsize',25)

lg = legend('k_{ew}=50 s^{-1}','k_{ew}=500 s^{-1}', 'k_{ew}=1000 s^{-1}','k_{ew}=2000 s^{-1}','k_{ew}=3000 s^{-1}','k_{ew}=4000 s^{-1}','location','southoutside','fontsize',20,'NumColumns',2,'Box','off');
