...
kon_list = [1e3, 1e4, 1e5, 1e6, 1e7, 1e8];
...
lg = legend('k_{on}=10^3 M^{-1}s^{-1}', 'k_{on}=10^4 M^{-1}s^{-1}','k_{on}=10^5 M^{-1}s^{-1}','k_{on}=10^6 M^{-1}s^{-1}','k_{on}=10^7 M^{-1}s^{-1}','k_{on}=10^8 M^{-1}s^{-1}','location','southoutside','fontsize',20,'NumColumns',2,'Box','off');
