...
lg = legend('k''_{on}=10 s^{-1}', 'k''_{on}=50 s^{-1}','k''_{on}=100 s^{-1}','k''_{on}=200 s^{-1}','k''_{on}=500 s^{-1}','k''_{on}=1000 s^{-1}','location','southeast','fontsize',22);
