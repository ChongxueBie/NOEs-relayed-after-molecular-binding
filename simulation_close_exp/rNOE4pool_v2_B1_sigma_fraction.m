...
R21=1/1.8; R24=1/0.6;% R21: R2 for I; R22: R2 for S
...
% sigma_list = [5e4, 5e5, 5e6, 5e7, 5e8];
sigma_list = [5e2, 5e3, 5e4, 5e5, 5e6, 5e7];
pp = 0;
...
u23 = 2*sigma; u32 = u23*M20/M30;
n23 = -1*sigma; n32 = n23*M20/M30;
...
figure(2);
plot(wplist,(signal(pp,:)/signal(pp,end)),'-','markersize',8,'linestyle','-','linewidth',4,'Color',colorList{pp}); hold on;
hold on;
...
pp=pp+1;
plot(wplist*2*pi,(signal(pp,:)/signal(pp,end)),'-','markersize',8,'linestyle','-','linewidth',4,'Color',colorList{pp}); hold on;
hold on;
...
ylabel('\alpha')
set(gca,'ytick',[0:0.2:200],'ylim',[0,1.05],'xtick',[0:50:1000],'xlim',[0,300],'fontsize',20)

% lg = legend('\sigma_{ea}=-5\times10^4 s^{-1}','\sigma_{ea}=-5\times10^5 s^{-1}','\sigma_{ea}=-5\times10^6 s^{-1}','\sigma_{ea}=-5\times10^7 s^{-1}','\sigma_{ea}=-5\times10^8 s^{-1}','location','southeast','fontsize',20);
lg = legend('\sigma_{ea}=-5\times10^2 s^{-1}','\sigma_{ea}=-5\times10^3 s^{-1}','\sigma_{ea}=-5\times10^4 s^{-1}','\sigma_{ea}=-5\times10^5 s^{-1}','\sigma_{ea}=-5\times10^6 s^{-1}','\sigma_{ea}=-5\times10^7 s^{-1}','location','southeast','fontsize',22);
