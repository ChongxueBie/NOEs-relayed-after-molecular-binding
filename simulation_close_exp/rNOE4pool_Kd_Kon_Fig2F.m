...
M40 = na*L; M30 = na*LB; M20 = M30; M10=110; 
k21 = 1000;
k12 = k21*M20/M10;
...
% 
% figure(2); 
% surf(log10(kd),log(kon),signal'*100)
% colormap(jet)
% 
% % set(gca,'zlim', [0.0 40],'ztick',[0:10:100],'ylim',[0 6],'ytick',[0:1:6],'xlim',[-4, 4],'xtick',[-4:2:4]);
% %
% 
% xlabel('K_D (M)')
% ylabel('K_{off} (S^{-1})')
...
% 
% set(gca,'fontsize',20)
% set(gcf, 'Position',  [100, 100, 580, 520])
...
figure(3)
imagesc(signal'*100, 'YData', log10(kbind_list), 'XData', log10(kd_list))
